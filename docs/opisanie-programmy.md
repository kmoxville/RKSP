...
Самыловских А.И., группа ССПО-П-ИСиТ-нетология-2, лабораторная работа №3
...
### 3.2 ERD-диаграмма (нотация Чена)

![ERD нотация Чена](erd-chen.png)

Сущности: RAW_UNIVERSITY_EVENTS (сырые события), EVENTS_AGGREGATES (агрегаты). Связь ПОДСЧИТЫВАЕТ (1:N). Подробности — в [erd.md](erd.md).
